...
describe('Header Component', () => {
  ...
  test('renders the header description', () => {
    const descriptionElement = screen.getByText(/Gateway to the West - where history, architecture, and innovation meet along the Mississippi River./i);
  ...
  test('description has correct text content', () => {
    const descriptionElement = screen.getByText(/Gateway to the West - where history, architecture, and innovation meet along the Mississippi River./i);
    expect(descriptionElement.textContent).toBe('Gateway to the West - where history, architecture, and innovation meet along the Mississippi River.');
  });
});
